...
constexpr int MOTORCONTROL_IN1_PIN = 14;
constexpr int MOTORCONTROL_IN2_PIN = 27;
constexpr int MOTORCONTROL_IN3_PIN = 25;
constexpr int MOTORCONTROL_IN4_PIN = 26;
...
void setup() {
    ...
    pinMode(MOTORCONTROL_IN1_PIN, OUTPUT);
    pinMode(MOTORCONTROL_IN2_PIN, OUTPUT);
    pinMode(MOTORCONTROL_IN3_PIN, OUTPUT);
    pinMode(MOTORCONTROL_IN4_PIN, OUTPUT);
...
void loop() {
    ...
    setMotorPwm(MOTORCONTROL_IN1_PIN, MOTORCONTROL_IN2_PIN, motorPwmDutyCycleLeft);
    setMotorPwm(MOTORCONTROL_IN3_PIN, MOTORCONTROL_IN4_PIN, motorPwmDutyCycleRight);
